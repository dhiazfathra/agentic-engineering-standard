...
- 2026-09-23 libsql enforces foreign keys by default (no `PRAGMA foreign_keys` needed). Its errors carry `extendedCode` (`SQLITE_CONSTRAINT_FOREIGNKEY`, `SQLITE_CONSTRAINT_UNIQUE`); `apps/web/src/lib/http.ts` maps those to 400/404/409.
